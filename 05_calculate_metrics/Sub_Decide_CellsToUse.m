function CellUse = Sub_Decide_CellsToUse(dF_F, SNR, Threshold, nearby_CellUse, out_path)

global SplitFreq

%FolderName = fullfile('Result');
FolderName = fullfile(out_path);
%mkdir(FolderName);
...
CellUse = dFF_flag1 & dFF_flag2 & SN_flag' & nearby_CellUse;
